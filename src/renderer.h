...
private:
    ...
    float m_clockFrac = 0.20f; // overlay (clock) height as fraction of output; VANTALOCK_CLOCK_HEIGHT
    float m_clockY = 0.74f;    // overlay vertical centre as fraction of output height
};
